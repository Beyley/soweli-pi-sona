...
internal sealed class ManagedBassLowPassFilterAudioEffect : LowPassFilterAudioEffect {
	private readonly BQFParameters _parameters;

	private int _handle;

	public ManagedBassLowPassFilterAudioEffect(AudioStream stream) : base(stream) {
